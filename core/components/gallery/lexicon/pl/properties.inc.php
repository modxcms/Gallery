...
$_lang['gallery.albumrequestvar_desc'] = 'Jeżeli checkForRequestAlbumVar jest prawdą, będzie sprawdzać zmienną REQUEST o wskazanej nazwie w poszukiwaniu identyfikatora albumu do wyświetlenia.';
$_lang['gallery.checkforrequestalbumvar_desc'] = 'Jeżeli 1, to jeżeli znaleziono zmienną "album" w tablicy REQUEST, użyje jej wartości jako własności album w snippecie.';
$_lang['gallery.checkforrequesttagvar_desc'] = 'Jeżeli 1, to jeżeli znaleziono zmienną "tag" w tablicy REQUEST, użyje jej wartości jako własności tag w snippecie.';
...
$_lang['gallery.imagefar_desc'] = 'Wartość "far" dla phpThumb przetwarzającego obrazek, służy ustawieniu powiększania z zachowaniem proporcji (force aspect ratio).';
$_lang['gallery.imageheight_desc'] = 'Określa wysokość aktualnie wyświetlanego obrazu, jeśli jest obsługiwane przez wtyczkę.';
$_lang['gallery.imagegetparam_desc'] = 'Parametr GET używany jeżeli obrazy nie są linkowane bezpośrednio. Upewnij się, że odpowiada on właściwości getParam w wywołaniu snippetu GalleryItem.';
...
$_lang['gallery.imagezoomcrop_desc'] = 'Określa, czy aktualnie wyświetlany obraz powinien być powiększony z przycięciem (zoom crop), jeśli jest to obsługiwane przez wtyczkę.';
...
$_lang['gallery.linktoimage_desc'] = 'Jeżeli prawda, będzie tworzył łącza bezpośrednio do obrazu, w przeciwnym wypadku doda parametr GET do URL w celu ładowania obrazu przez snippet GalleryItem.';
$_lang['gallery.plugin_desc'] = 'Nazwa wtyczki używanej do wyświetlania galerii. Proszę zobaczyć oficjalną dokumentację w celu uzyskania listy dostępnych wtyczek.';
...
$_lang['gallery.start_desc'] = 'Indeks, od którego rozpocząć pobieranie obrazów jeśli jest ustawiony limit ich liczby. Działa podobnie do klauzuli order by start w języku SQL.';
$_lang['gallery.tag_desc'] = 'Ładuje jedynie obrazy ze wskazanym znacznikiem.';
$_lang['gallery.tagrequestvar_desc'] = 'Jeżeli checkForRequestTagVar jest prawdą, będzie sprawdzać zmienną REQUEST o wskazanej nazwie w celu ustawienia znacznika.';
$_lang['gallery.toplaceholder_desc'] = 'Jeżeli ustawione, przekaże wyjście do placeholdera o podanej nazwie i wywołanie snippetu nic nie zwróci.';
$_lang['gallery.thumbfar_desc'] = 'Wartość "far" dla phpThumb przetwarzającego miniaturę, służy ustawieniu powiększania z zachowaniem proporcji (force aspect ratio).';
...
$_lang['galleryalbums.albumrequestvar_desc'] = 'Jeżeli checkForRequestAlbumVar jest prawdą, będzie sprawdzać zmienną REQUEST o wskazanej nazwie w poszukiwaniu identyfikatora albumu do wyświetlenia.';
$_lang['galleryalbums.albumcoversort_desc'] = 'Pole, według którego sortować w celu wybrania okładki albumu. Aby wybrać pierwszy obraz, użyj "rank". Aby wybrać losowy obraz, użyj "random".';
$_lang['galleryalbums.albumcoversortdir_desc'] = 'Kierunek sortowania przy wyborze okładki albumu. Przyjmowane wartości to "ASC" lub "DESC".';
...
$_lang['galleryalbums.parent_desc'] = 'Pobierz tylko albumy, których albumem nadrzędnym (rodzicem) jest określony przez podane ID.';
...
$_lang['galleryalbums.showall_desc'] = 'Jeśli 1, pokaże wszystkie albumy, niezależnie od albumu nadrzędnego (rodzica).';
...
$_lang['galleryalbums.start_desc'] = 'Indeks, od którego rozpocząć pobieranie wyników.';
$_lang['galleryalbums.sort_desc'] = 'Pole, według którego sortować wyniki.';
$_lang['galleryalbums.thumbfar_desc'] = 'Wartość "far" dla phpThumb przetwarzającego miniaturę okładki albumu, służy ustawieniu powiększania z zachowaniem proporcji (force aspect ratio).';
$_lang['galleryalbums.thumbheight_desc'] = 'Wysokość generowanej miniatury okładki albumu, wyrażona w pikselach.';
$_lang['galleryalbums.thumbproperties_desc'] = 'Obiekt JSON zawierający parametry przekazywane do phpThumb jako ustawienia miniatury okładki albumu.';
$_lang['galleryalbums.thumbquality_desc'] = 'Wartość "q" dla phpThumb oznaczająca jakość miniatury okładki albumu.';
$_lang['galleryalbums.thumbwidth_desc'] = 'Szerokość wygenerowanej miniatury okładki albumu, wyrażona w pikselach.';
...
$_lang['galleryitem.imagefar_desc'] = 'Wartość "far" dla phpThumb przetwarzającego obraz, służy ustawieniu powiększania z zachowaniem proporcji (force aspect ratio).';
...
$_lang['galleryitem.imageproperties_desc'] = 'Obiekt JSON zawierający parametry przekazywane do phpThumb jako ustawienia generowanego obrazu.';
$_lang['galleryitem.imagequality_desc'] = 'Wartość "q" dla phpThumb oznaczająca jakość obrazu.';
$_lang['galleryitem.imagewidth_desc'] = 'Określa maksymalną szerokość aktualnie wyświetlanego obrazu, jeśli jest obsługiwane przez wtyczkę.';
...
$_lang['galleryitem.tagseparator_desc'] = 'Separator ciągów znaków listy znaczników obrazu.';
$_lang['galleryitem.tagsortdir_desc'] = 'Kierunek sortowania znaczników obrazu.';
$_lang['galleryitem.tagtpl_desc'] = 'Nazwa fragmentu, który powinien być użyty dla każdego znacznika określonego dla obrazu.';
$_lang['galleryitem.toplaceholders_desc'] = 'Jeśli prawda, ustawi właściwości obrazu do placeholderów, w przeciwnym wypadku użyje parametru tpl aby wygenerować fragment.';
$_lang['galleryitem.toplaceholdersprefix_desc'] = 'Opcjonalny. Prefiks który będzie dodawany do placeholderów ustawionych przez ten snippet. Działa tylko jeśli toPlaceholders jest ustawiona jako prawda.';
$_lang['galleryitem.tpl_desc'] = 'Nazwa fragmentu używanego jeśli wartość toPlaceholders jest ustawiona jako fałsz.';

 ...
 */
/**
 * Default Polish Lexicon Entries for Gallery
 * Translated by Jakub Kalina (modx@jakubkalina.pl)
 *
 * @package gallery
 * @subpackage lexicon
 */
$_lang['gallery'] = 'Galeria';
$_lang['gallery.year'] = 'Rok';
$_lang['gallery.active'] = 'Aktywny';
$_lang['gallery.active_desc'] = 'Jeśli niezaznaczone, album nie będzie widoczny.';
...
$_lang['gallery.delete_cover'] = 'Usuń okładkę';
$_lang['gallery.directory'] = 'Katalog';
$_lang['gallery.directory_desc'] = 'Katalog, w którym szukać obrazów.';
$_lang['gallery.directory_err_create'] = 'Nie można utworzyć katalogu: [[+directory]]';
$_lang['gallery.directory_err_nf'] = 'Nie znaleziono katalogu.';
$_lang['gallery.directory_err_ns'] = 'Nie określono katalogu.';
$_lang['gallery.directory_err_write'] = 'Nie można zapisać do katalogu: [[+directory]]';
$_lang['gallery.file'] = 'Plik';
$_lang['gallery.file_err_move'] = 'Wystąpił błąd podczas przenoszenia pliku: [[+file]] do [[+target]]';
$_lang['gallery.file_name'] = 'Nazwa pliku';
$_lang['gallery.file_size'] = 'Wielkość pliku';
...
$_lang['gallery.item_delete_multiple'] = 'Usuń zaznaczone obrazy';
$_lang['gallery.item_delete_multiple_confirm'] = 'Czy na pewno chcesz usunąć te obrazy? Ta zmiana jest nieodwracalna.';
$_lang['gallery.item_err_nf'] = 'Nie znaleziono obrazu.';
$_lang['gallery.item_err_ns'] = 'Nie określono obrazu.';
$_lang['gallery.item_err_ns_file'] = 'Proszę wskazać plik do przesłania.';
$_lang['gallery.item_err_remove'] = 'Wystąpił błąd podczas próby usunięcia obrazu.';
$_lang['gallery.item_err_save'] = 'Wystąpił błąd podczas próby zapisania obrazu.';
$_lang['gallery.item_err_upload'] = 'Wystąpił błąd podczas próby przesłania obrazu.';
$_lang['gallery.item_remove'] = 'Usuń obraz';
$_lang['gallery.item_remove_album'] = 'Usuń obraz z albumu';
$_lang['gallery.item_update'] = 'Aktualizuj obraz';
$_lang['gallery.item_upload'] = 'Prześlij obraz';
$_lang['gallery.item_upload_file_desc'] = 'Plik obrazu, który chcesz przesłać.';
$_lang['gallery.item_url'] = 'URL';
$_lang['gallery.item_url_desc'] = 'Łącze (URL), do którego przesłać użytkownika po kliknięciu tego obrazu.';
$_lang['gallery.items'] = 'Obrazy';
$_lang['gallery.loading_ellipsis'] = 'Ładowanie...';
$_lang['gallery.menu_desc'] = 'Dynamiczny system galerii.';
...
$_lang['gallery.upload'] = 'Prześlij';
$_lang['gallery.upload_cover'] = 'Prześlij okładkę';
$_lang['gallery.view_cover'] = 'Zobacz okładkę';
